...
export default function Home() {
  return (
    <div className="flex-grow flex items-center justify-center p-6 md:p-12">
      ...
      */}
      <section className="bg-white/60 backdrop-blur-lg rounded-3xl p-8 md:p-16 max-w-4xl w-full text-center shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/50">
